            ...
            {selectedReservation && (
                <Modal show={message} onHide={handleCloseMessage}>
                    <Modal.Header closeButton>
                        <Modal.Title>{selectedReservation.name}</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        ...
                        <div>Full name: {selectedReservation.user.name}</div>
                        <div>
                            Birth date: {selectedReservation.user.birth_date}
                        </div>
                        <div>Gender: {selectedReservation.user.gender}</div>
                        <div>ID Type: {selectedReservation.user.id_type}</div>
